...
%global pkg_name nanoeigenpy
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-nanoeigenpy
Version:        0.5.0
Release:        3%{?dist}
Summary:        ROS %{pkg_name} package

License:        BSD-3-Clause
URL:            https://github.com/Simple-Robotics/nanoeigenpy
...
%description
A support library for bindings between Eigen in C++ and Python, based on
nanobind
...
%changelog
* Wed Apr 29 2026 Guilhem Saurel <guilhem.saurel@laas.fr> - 0.5.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Guilhem Saurel <guilhem.saurel@laas.fr> - 0.5.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Guilhem Saurel <guilhem.saurel@laas.fr> - 0.5.0-1
- Autogenerated by Bloom
